...
def insert_token_in_cookie(token_obj: AuthToken) -> str:
    ...
    cookie: str = (
        f"access_token=Bearer {token_obj.access_token}; "
        "max-age={settings.ACCESS_TOKEN_EXPIRY_IN_SECONDS}; "
        "path=/; Secure; HttpOnly"  # noqa
    )

    # Set all cookies to be secure whether in prod or localhost
